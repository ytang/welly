...
- (void)setContent:(id)content {
	...
	if (content) {
		...
		if ([content respondsToSelector:NSSelectorFromString(@"setTabViewItemController:")])
			[content performSelector:NSSelectorFromString(@"setTabViewItemController:") withObject:self];
	} else {
